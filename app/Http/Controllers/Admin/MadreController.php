...
class MadreController extends AdminController {
    ...
    */
    ...
    {
        // Show the page
        return view('admin.madres.index');
    }
    ...
    public function getCreate() {
        return view('admin.madres.create_edit');
    }
    ...
    public function getEdit($id) {
        ...
        $user = User::find($id);
        return view('admin.madres.create_edit', compact('user'));
    }
    ...
    public function getDelete($id)
    {
        $user = User::find($id);
        // Show the page
        return view('admin.maadres.delete', compact('user'));
    }
    ...
    {
        $users = User::where('admin','=','madre')->select(array('users.id','users.name','users.admin','users.email','users.confirmed'));
